...
{
    public partial class CreatingTablesWithSeed : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IdentityUsersBooks", x => new { x.IdentityUserId, x.BookId });
                    table.ForeignKey(
                        name: "FK_IdentityUsersBooks_AspNetUsers_IdentityUserId",
